...
const HomePage = () => {
  ...
  const genres = ['Fiction', 'Non-Fiction', 'Mystery', 'Horror', 'Action', 'Adventure'];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <Text style={styles.headerText}>Reading App</Text>
      </View>
      ...
      <View style={styles.statisticsContainer}>
        ...
        <Text style={styles.statDetail}>Total Number of Pages Read: {totalPagesRead}</Text>
        <Text style={styles.statDetail}>Average Number Pages per Book: {averagePagesPerBook.toFixed(2)}</Text>
      </View>

      <TouchableOpacity onPress={() => setModalVisible(true)} style={styles.addButton}>
        <Text style={styles.addButtonText}>Add Your Book Here</Text>
      </TouchableOpacity>

      {}
      <Modal animationType="slide" transparent={true} visible={modalVisible}>
        <View style={styles.modalContainer}>
          <Text style={styles.modalHeader}>Add Your Book Here</Text>
          <TextInput
            style={styles.input}
          ...
          <TouchableOpacity style={styles.addBookButton} onPress={addBook}>
            <Text style={styles.addBookButtonText}>Add Entered Book</Text>
          </TouchableOpacity>
